...
### `previous_issue_used_to_displace_current_issue` — N2 · Aufrechnen
...
### `whataboutism_candidate` — N3 · Whataboutism
...
### `problem_mixing` — N5 · Problemvermischung
...
### `responsibility_shift` — N6 · Verantwortungsverschiebung
...
### `impact_relativized` — N7 · Wirkung relativiert
...
### `intent_attribution` — N8 · Absichtsunterstellung
...
### `generalization_candidate` — N9 · Verallgemeinerung
...
### `criticism_justification_loop` — N10 · Kritik-Rechtfertigungs-Schleife
...
### `responsibility_taken` — P2 · Verantwortungsübernahme
...
### `topic_return` — P3 · Themenrückkehr
...
### `agreement_reached` — P4 · Vereinbarung
...
### `concern_stated_without_blame` — P5 · Anliegen ohne Vorwurf formuliert
...
### `clarifying_question` — P6 · Nachfrage statt Annahme
...
### `perception_validated` — P7 · Wahrnehmung des anderen bestätigt
...
### `deescalation` — P8 · Bewusste Deeskalation
...
### `affection_in_conflict` — P9 · Zuneigung/Wärme im Konfliktkontext
...
### `apology_present` — E1 · Situation enthält eine Entschuldigung
...
### `not_a_real_situation` — Z1 · Keine echte Situation
...
### `incomplete` — Z2 · Situation unvollständig
...
### `merged_situations` — Z3 · Situationen vermischt
